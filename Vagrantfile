...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "rtdavis22-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/rtdavis22"
  #   chef.validation_client_name = "rtdavis22-validator"
  #   chef.validation_key_path = ".chef/rtdavis22-validator.pem"
  # end
end
